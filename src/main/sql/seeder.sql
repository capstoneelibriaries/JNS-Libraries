...
VALUES ("Ipsum dolor", "Morbi dictum dui diam, ut luctus quam commodo sed. Morbi in porta lectus. Integer dapibus justo est.", 14.99, 5.67, false, 1),
       ...
       ("Mercator in foro", "Nullam et arcu lorem. Aenean sed orci dui. Suspendisse id enim eget massa ullamcorper aliquet. Aliquam vehicula tellus eu nisl semper porta. Sed a dolor nec lacus dapibus egestas. Proin lobortis congue maximus.", 28.00, 0.0, false, 2),
