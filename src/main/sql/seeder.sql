...
VALUES ("Ipsum dolor", "Morbi dictum dui diam, ut luctus quam commodo sed. Morbi in porta lectus. Integer dapibus justo est.", 14.99, 5.67, true, 1, true),
       ("Lorem dolor", "Suspendisse fringilla sollicitudin arcu. Aenean egestas justo lacus, sit amet pretium neque ullamcorper eget. In in metus commodo, dapibus turpis in, ultrices tortor. Proin sodales at libero malesuada imperdiet.", 12.25, 0.0, true, 1, true),
       ("Mercator in foro", "Nullam et arcu lorem. Aenean sed orci dui. Suspendisse id enim eget massa ullamcorper aliquet. Aliquam vehicula tellus eu nisl semper porta. Sed a dolor nec lacus dapibus egestas. Proin lobortis congue maximus.", 28.00, 0.0, true, 2, true),
       ("Laborat", "Maecenas consectetur sed nunc pharetra varius. Ut imperdiet libero metus, sit amet rutrum mi egestas at. Ut et tortor vel nisl imperdiet dapibus varius ut ex. Suspendisse eu ligula enim. Phasellus rhoncus porta risus, sit amet lacinia leo maximus eu. Vivamus interdum.", 25.30, 9.40, true, 4, true),
       ("Morbi at lacus lorem", "Ut eget elit sed sapien malesuada tincidunt. Etiam maximus ligula vitae mauris varius, ut fringilla sem congue. Mauris et hendrerit est. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Vestibulum at volutpat ligula. Orci varius natoque penatibus.", 7.99, 4.33, true, 2, true),
       ("Nam id ex neque", "Quisque in lobortis dui. In sollicitudin augue et neque vehicula venenatis. Quisque eros lorem, fermentum aliquet arcu sit amet, dapibus dignissim nulla. Cras ultrices odio massa, a ullamcorper ligula fringilla non. Integer sed congue mauris. Aenean vitae lectus metus. Pellentesque euismod interdum.", 4.83, 12.6, true, 4, true),
       ("Curabitur imperdiet", "Curabitur maximus consequat efficitur. Praesent consequat faucibus diam sed blandit. In placerat urna dolor, vel aliquam odio blandit eget. Interdum et malesuada fames ac ante ipsum primis in faucibus. Donec vel varius justo. Nullam vel leo arcu. Duis at tortor et ante.", 44.44, 5.00, true, 5, true);
